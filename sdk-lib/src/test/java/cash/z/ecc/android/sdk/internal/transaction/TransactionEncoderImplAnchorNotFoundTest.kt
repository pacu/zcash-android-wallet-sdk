...
/**
 * Pins the mapping this PR exists for: a native [ProposalAnchorNotFoundException] reaching
 ...
 * The previous revision of this change instrumented entry points that could never actually throw
 * this exception, so the mapping looked correct but never fired; these tests exercise the mapping
 * directly against a faked [TypesafeBackend], independent of the native layer.
 */
